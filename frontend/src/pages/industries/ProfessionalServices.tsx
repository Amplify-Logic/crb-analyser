...
const SAMPLE_FINDINGS = [
  {
    ...
    description: 'Your current process shows clear automation potential. High ROI with minimal risk.',
    roi: '€18,000/year',
  },
  {
    ...
    verdictColor: 'amber',
    description: 'Potential is there, but requires clear templates and review workflow first.',
    roi: '€12,000/year',
  },
  {
